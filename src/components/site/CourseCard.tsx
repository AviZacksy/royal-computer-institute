  ...
  return (
    <div className="group relative flex flex-col bg-white overflow-hidden shadow-sm hover:shadow-lg border border-gray-100 transition-all duration-300">
      ...
      <div className="flex flex-col flex-1 p-4">
        <h3 className="text-xl font-bold text-gray-900 font-display text-center">
        ...
        {description && (
          <p className="mt-3 text-sm text-gray-500 flex-1 line-clamp-2 text-center">
            {description}
          </p>
        )}
        ...
        {fee && (
          <div className={`overflow-hidden transition-all duration-500 ease-in-out ${isExpanded ? 'max-h-[200px] opacity-100' : 'max-h-0 opacity-0'}`}>
            <div className="mt-3 pt-3 border-t border-gray-100">
              <div className="flex flex-col gap-1 text-[13px] font-medium text-gray-700">
        ...
        <div className="mt-4 flex items-center justify-between pt-3 border-t border-gray-100">
          <div className="flex items-center gap-1 text-[#2563eb] font-bold text-base">
            <Clock className="w-4 h-4 fill-[#2563eb] text-white" />
            <span>{duration}</span>
          </div>
          ...
          <button 
            ...
            className="bg-[#3b82f6] text-white text-[13px] font-medium px-4 py-2 rounded hover:bg-[#2563eb] transition-colors relative z-10 shadow-sm"
          >
